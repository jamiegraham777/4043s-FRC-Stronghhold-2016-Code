...
public class SingleEncoder extends SensorBase implements CounterBase, PIDSource, LiveWindowSendable {
	  ...
	  // tick
	  private NewCounter m_counter; // Counter object for 1x and 2x encoding
	  ...
	  private void initEncoder(boolean reverseDirection) {
	    switch (m_encodingType) {
	      ...
	      case k1X:
	        ...
	        m_counter = new NewCounter(m_encodingType, m_aSource, reverseDirection);
	   ...
	   *        positive values.
	   */
	  public SingleEncoder(final int aChannel, final int bChannel, boolean reverseDirection) {
	    m_allocatedA = true;
	    m_allocatedB = true;
	    m_allocatedI = false;
	   ...
	   */
	  public SingleEncoder(final int aChannel, final int bChannel) {
	  ...
	  public SingleEncoder(final int aChannel, boolean reverseDirection, final EncodingType encodingType) {
		  m_allocatedA = true;
		  m_allocatedI = false;
		  if (encodingType == null)
			  throw new NullPointerException("Aghhhh there's nullll - noeeessssss");
		  m_encodingType = encodingType;
		  m_aSource = new DigitalInput(aChannel);
		  initEncoder(reverseDirection);
	   ...
	   *        positive values.
	   */
	  public SingleEncoder(final int aChannel, final int bChannel, final int indexChannel,
	   ...
	   *        positive values.
	   */
	  public SingleEncoder(DigitalSource aSource, DigitalSource bSource, boolean reverseDirection) {
	    m_allocatedA = false;
	    m_allocatedB = false;
	    m_allocatedI = false;
	    if (aSource == null)
	   ...
	   * @param bSource the source that should be used for the b channel.
	   */
	  public SingleEncoder(DigitalSource aSource, DigitalSource bSource) {
	   ...
	   *        positive values.
	   */
	  public SingleEncoder(DigitalSource aSource, DigitalSource bSource, DigitalSource indexSource,
	      boolean reverseDirection) {
	    m_allocatedA = false;
	    m_allocatedB = false;
	    m_allocatedI = false;
