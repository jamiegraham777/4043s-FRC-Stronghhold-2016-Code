 ...
 */
public class NewCounter extends SensorBase implements CounterBase, LiveWindowSendable, PIDSource {
   ...
   */
  public NewCounter(DigitalSource source) {
    if (source == null)
   ...
   */
  public NewCounter(EncodingType encodingType, DigitalSource upSource, DigitalSource downSource,
      boolean inverted) {
  ...
  public NewCounter(EncodingType encodingType, DigitalSource upSource, 
	      boolean inverted) {
	    initCounter(Mode.kExternalDirection);
	    if (encodingType != EncodingType.k1X && encodingType != EncodingType.k2X) {
	      throw new RuntimeException("Counters only support 1X and 2X quadreature decoding!");
   ...
   */
  public NewCounter(AnalogTrigger trigger) {
    if (trigger == null) {
